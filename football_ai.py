...
class MatchAnalyzer:
    def form_score(self, wins, draws, losses): 
        ...
        # Not: İleride momentumu daha agresif yapmak istersen '- (losses * 0.5)' eklenebilir.
        return (wins * 3) + draws
    ...
    def manual_probability_matrix(self, home_xg, away_xg, ht_home_xg, ht_away_xg):
        ...
        # 8 gol üstü ihtimaller çok zayıf olduğu için range(8) makul
        for h in range(8):
            for a in range(8):
        ...
        # Olasılıkları normalize et (Toplamı kesinlikle 1.0 olsun diye)
