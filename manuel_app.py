...
# --- 2. KULLANICI VERİTABANI VE 20 GÜN KONTROLÜ ---
# Yeni müşteri geldiğinde buradaki listeye alt alta ekleme yapabilirsin.
MUSTERILER = {
    "giray_admin": {
        "sifre": "patron123",
        "bitis_tarihi": "2030-12-31" # Senin sonsuz erişimin
    },
    "ilk_musteri": {
        "sifre": "deneme20",
        "bitis_tarihi": "2026-08-20" # 20 günlük deneme süresi örneği
    }
}
...
def login_ekrani():
    ...
    with st.form("login_form"):
        ...
        if submit_button:
            if kullanici_adi in MUSTERILER and MUSTERILER[kullanici_adi]["sifre"] == sifre:
                ...
                if bugun <= bitis_tarihi:
                    ...
                    st.error("⚠️ 20 Günlük Deneme Süreniz Dolmuştur! VIP üyeliğe geçmek için lütfen iletişime geçin.")
            else:
